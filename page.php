...
<form method="POST" action="./sms/proc_sms_staff.php">
    ...
    <p>&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br /></p>
    <h2>Page CRISIS SUPPORT TEAM - Question</h2>
    
    <p>Optional: text to crisis support team
      <input type=text name=help_text size = 60 /></p>
    <p><input style="height: 50px; width: 250px; font-weight: bold;   color:black; background-color:#FC3" type = submit name=help value ='ASK QUESTION' /></p>
