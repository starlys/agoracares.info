...
<form method="POST" action="./sms/proc_sms_staff.php">
    <h2>Page CRISIS SUPPORT TEAM - Suicide In Progress</h2>
    <p>Optional: text to crisis support team
      <input type=text name=suicide_text size = 60 /></p>
    <p><input style="height: 100px; width: 250px; font-weight: bold;   color:white; background-color:#F00;" type = submit name=suicide value ='SUICIDE IN PROGRESS' /></p>
    <p>&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br /></p>
