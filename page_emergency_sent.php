<?php require_once "./lib/doc_info.php"; ?>
    ...
    <h2>EMERGENCY HELP NEEDED - Page Sent</h2>
    <p>Staff should respond in a few minutes, and someone will be on their way to the center to assist. </p>
    
    <p>You requested assistance from staff. They should contact you soon. </p><p>If this is (or becomes) an <strong>EMERGENCY</strong> situation, click the PAGE link on the left and page EMERGENCY HELP NEEDED. Remember to use the checklist to help assess lethality if you are talking with someone who is in a severe crisis situation.</p>
