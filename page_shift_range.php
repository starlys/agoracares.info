...
<h2>Shift Coverage From <?php echo date('m/d/y',$start_timestamp)." To ".date('m/d/y',$end_timestamp); ?></h2>
<table >
<tr><td><strong>Total Coverage:</td><td> <?php echo  $shift_hrs." hours ".$shift_mins." minutes";?></strong></td></tr>
</table>
<p></p>
...
<?php
$first = 1;
echo "<tr><th>Date</th><th>Start</th><th>End</th><th>Shift Time</th><th>Volunteer</th></tr>";
